...
$client = (new ClientBuilder())
    ...
    ->withValinorCache(ValinorCacheFactory::make()) // Optional Valinor cache implementation for caching auto-mapping DTO, default is null, more information: https://valinor-php.dev/2.3/other/performance-and-caching/
